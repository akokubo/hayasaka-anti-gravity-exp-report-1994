...
- 反重力に関する早坂氏による理論的研究
  ...
  　ここで、 Ｈは階段関数です。 H の x 微分はどうも角運動量ωのδ関数の
...
- 反重力実験の原点とは？
  ...
  LaTeXとかの ¥oplus、$ \oplus $みたいなやつ）に関してはどう思われますか？」
...
原著 Louis Pauwels, Jacques Bergier, "Le Matin des magiciens, introduction au réalisme fantastique(日本語にすると、魔術師たちの朝: 幻想的リアリズム入門)", Éditions Gallimard, 1960.
